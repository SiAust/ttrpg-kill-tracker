export function Player({id, characterName, player, level, clazz, race, killStats}) {
    this.id = id;
...
// Player.killStats.toString = () => `Jello`;
...
export const THURSDAY_PLAYERS = [
    new Player({
        id: 0, player: "Tony", characterName: "Toorg", level: 3, clazz: "Druid", race: "Leshy",
        killStats: [
    ...
    new Player({
        id: 1, player: "Jon", characterName: "Haarsk", level: 3, clazz: "?", race: "Dwarf",
        killStats: [
            {id: 0, type: "goblin", count: 4},
    ...
    new Player({
        id: 2, player: "Lewis", characterName: "Ulrock", level: 3, clazz: "Fighter", race: "Hobgoblin",
        killStats: [
    ...
    new Player({
        id: 3, player: "Chantelle", characterName: "Selenite", level: 3, clazz: "Alchemist", race: "Fae?",
        killStats: [
            {id: 0, type: "goblin", count: 4},
            {id: 1, type: "orc", count: 2},
            {id: 2, type: "ogre", count: 1}]
    ...
    new Player({
        id: 4, player: "Simon", characterName: "Tamasso", level: 3, clazz: "Fighter", race: "Human",
        killStats: [
